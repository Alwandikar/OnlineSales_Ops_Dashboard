"""
pages/2_Disposition_Detail.py — CS Online Team · Disposition Detail
"""
...
from utils.components import (
    agent_disposition_bar,
    date_banner,
    disp_card,
    disposition_stacked_bar,
    empty_state,
...
st.set_page_config(
    page_title="CS Online Team · Disposition Detail",
    page_icon="📋",
    layout="wide",
...
top_nav(
    ...
    page_tag="Disposition Detail",
    logo_class="nav-logo-disp",
    tag_class="tag-green",
    logo_icon="📋",
)
...
camp_filter = st.radio(
    "Campaign", ["All Campaigns", "Sports", "Holiday"],
...
# Overall disposition cards — now 6 dispositions
...
# Agent × Disposition table (returns pivot for reuse)
